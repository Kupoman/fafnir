...
from fafnir.resolve_intersections_pass import ResolveIntersectionsPass
...
def test_resolve_intersections(graphics_context, gsg, half_screen_quad, camera):
    ...
    # Check data type
    assert texture.get_component_type() == p3d.Texture.T_unsigned_byte
    assert texture.get_format() == p3d.Texture.F_rgb8
